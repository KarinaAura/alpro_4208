...
int main() {
    ...
    if (indeksGanjilTerkecil != -1) {
        cout << "Nilai ganjil terkecil: " << arr[indeksGanjilTerkecil] << ", indeks: " << indeksGanjilTerkecil << std::endl;
    } else {
        cout << "Tidak ada bilangan ganjil dalam urutan bilangan." << std::endl;
    }

    if (indeksGenapTerkecil != -1) {
        cout << "Nilai genap terkecil: " << arr[indeksGenapTerkecil] << ", indeks: " << indeksGenapTerkecil << std::endl;
    } else {
        cout << "Tidak ada bilangan genap dalam urutan bilangan." << std::endl;
    }
